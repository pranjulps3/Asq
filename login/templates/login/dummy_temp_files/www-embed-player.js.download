...
timeout:c.timeout,withCredentials:!0},e=Vc();e&&(d.headers.Authorization=e,d.headers["X-Goog-AuthUser"]=M("SESSION_INDEX",0));e=this.b.xhrApiaryHost;e.startsWith("http")||(e="//"+e);R("youtubei_for_web")&&(e="");var f=this.b.Oa;f&&(e=f);Ig(""+e+sc(this.b.innertubeApiVersion,a,b)+"?alt=json&key="+this.b.innertubeApiKey,d)};var Xg={},Yg=0;function Zg(a,b){a&&(M("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)?Dg(a,b):$g(a,b))}
...
Jh.prototype.o=function(){Lh(this);Jh.A.o.call(this)};var Mh={vc:!0},Nh={ad_at:"adType",cpn:"clientPlaybackNonce",csn:"clientScreenNonce",is_nav:"isNavigation",yt_lt:"loadType",yt_ad:"isMonetized",yt_ad_pr:"prerollAllowed",yt_red:"isRedSubscriber",yt_vis:"isVisible",docid:"videoId",plid:"videoId"},Oh="ap c cver ei yt_fss yt_li".split(" "),Ph=["isNavigation","isMonetized","prerollAllowed","isRedSubscriber","isVisible"],Qh=v(H.clearResourceTimings||H.webkitClearResourceTimings||H.mozClearResourceTimings||H.msClearResourceTimings||H.oClearResourceTimings||
t,H);
...
function Xh(){var a=Yh().info.yt_lt="hot_bg";Th().info_yt_lt=a;if(R("csi_on_gel"))if("yt_lt"in Nh){var b={},c=Nh.yt_lt;0<=Vb(Ph,c)&&(a=!!a);b[c]=a;a=Uh();c=Object.keys(b).join("");Fh("info_"+c+"_"+a)||(b.clientActionNonce=a,vh("latencyActionInfo",b,Wg))}else 0<=Vb(Oh,"yt_lt")||Q(Error("Unknown label yt_lt logged with GEL CSI."))}
